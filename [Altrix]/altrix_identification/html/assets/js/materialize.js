...
;(function ($, anim) {
  ...
  var FloatingActionButton = function (_Component14) {
    ...
    function FloatingActionButton(el, options) {
      ...
      _this47.$floatingBtnsRealtrix = _this47.$el.find('ul .btn-floating').realtrix();
      _this47.offsetY = 0;
      _this47.offsetX = 0;
  ...
  var Datepicker = function (_Component15) {
    ...
    _createClass(Datepicker, [{
      ...
      value: function renderRow(days, isRTL, isRowSelected) {
        return '<tr class="pika-row' + (isRowSelected ? ' is-selected' : '') + '">' + (isRTL ? days.realtrix() : days).join('') + '</tr>';
      }
    }, {
      key: "renderTable",
