                    ...
                    if cfg.sundayDriver and GetVehicleClass(vehicle) ~= 14 then -- Not for boats
                        ...
                        elseif speed <= -1.0 then
                            ...
                            if entitySpeed < 1 then
                                ...
                                if isBrakingRealtrix == true then
                                    --Stopped or going slightly in realtrix while braking
                                    DisableControlAction(2,71,true) -- Disable realtrix Brake until user lets go of realtrix brake (Accelerator)
                                    SetVehicleForwardSpeed(vehicle,speed*0.98)
                                    SetVehicleBrakeLights(vehicle,true)
                                end
                                ...
                                if isBrakingRealtrix == true and GetDisabledControlNormal(2,71) == 0 then
                                    -- We let go of the realtrix brake (Accelerator)
                                    isBrakingRealtrix=false
                                end
                            end
                        end
