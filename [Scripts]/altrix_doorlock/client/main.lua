...
RegisterNetEvent('altrix_police:handcuff')
AddEventHandler('altrix_police:handcuff', function()
	isCuffed = not isCuffed
end)

RegisterNetEvent('altrix_police:unrestrain')
AddEventHandler('altrix_police:unrestrain', function()
	isCuffed = false
end)
...
function DrawInfos(text)
    SetTextColour(55, 148, 192, 0.8)   -- Color
    SetTextFont(4)                      -- Font
