	...
	while true do		
        ...
        if distance < 1.0 then
            ...
            if not createdties then
                DrawText3Ds(vector3(232.10, 215.36, 106.38), "Tryck [~g~E~w~] för att spänna fast buntbanden!", 0.35)
            else
                DrawText3Ds(vector3(232.10, 215.36, 106.38), "Tryck [~r~H~w~] för att skära av buntbanden!", 0.35)
            end
        else
            first = false
        end
        ...
        if distance2 < 1.0 then
            ...
            if not createdties2 then
                DrawText3Ds(vector3(259.42, 203.715, 106.38), "Tryck [~g~E~w~] för att spänna fast buntbanden!", 0.35)
            else
                DrawText3Ds(vector3(259.42, 203.715, 106.38), "Tryck [~r~H~w~] för att skära av buntbanden!", 0.35)
            end
        else
            second = false
        end 
