...
Config.Zones = {
	SprayPaint = {
		Pos   = vector3(-199.25, -1324.34, 31.12),
		Size  = {x = 3.0, y = 4.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		Name  = _U('blip_name'),
		Hint  = "Tryck ~g~E~s~ för att ~b~lackera~s~ om ~y~fordonet~s~.",
		Part = "resprays"
	},

	Modify = {
		Pos   = vector3(-1612.57, -834.23, 10.08),
		Size  = {x = 7.0, y = 7.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		Name  = _U('blip_name'),
		Hint  = "Tryck ~g~E~s~ för att ~b~modifiera~s~ om ~y~fordonet~s~.",
		Part = "main"
	},

	Modify2 = {
		Pos   = vector3(-1625.44, -824.01, 10.10),
		Size  = {x = 7.0, y = 7.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		Name  = _U('blip_name'),
	...
	ShowCase = {
		Pos   = vector3(-1626.91, -825.89, -0.06),
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		Name  = _U('blip_name'),
		Hint  = "Tryck ~g~E~s~ för att ~b~visa~s~ en modifikation på ~y~fordonet~s~.",
		Part = "showcase"
	},
}
...
Config.Inkopning = {
	["Items"] = {
		{ label = "Motordel", item = "modEngine", price = 200 },
        { label = "Bromsdel", item = "modBrakes", price = 500 },
        { label = "Växellåda", item = "modTransmission", price = 550 },
        { label = "Fjädring", item = "modSuspension", price = 450 },
        { label = "Turbodel", item = "modTurbo", price = 350 }		
	}
}
...
function GetNeons()
	local neons = {
		...
		{ label = "GRÅ",		r = 112, 	g = 128, 	b = 144},
		{ label = "BLÅ",			r = 0, 		g = 0, 		b = 255},
		{ label = "LJUSBLÅ",		r = 0, 		g = 150, 	b = 255},
		{ label = "MARINBLÅ", 		r = 0, 		g = 0, 		b = 128},
		{ label = "HIMMELBLÅ", 		r = 135, 	g = 206, 	b = 235},
		{ label = "TURKOS", 		r = 0, 		g = 245, 	b = 255},
		{ label = "MINT GRÖN", 	r = 50, 	g = 255, 	b = 155},
		{ label = "LIMEGRÖN", 	r = 0, 		g = 255, 	b = 0},
		{ label = "OLIV", 			r = 128, 	g = 128, 	b = 0},
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {9.95, 12.56, 15.12, 18.53}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {9.65, 12.3, 15.6, 18.95}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {9.95, 12.93, 15.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {9.72, 12.44, 15.88, 18.77, 21.2}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {25.77, 28.28, 31.00, 34.00, 37.00, 40.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
