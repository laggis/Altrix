if Stripssss.Menu.Enabled then
    CreateThread(function()
        while not NetworkIsSessionStarted() do
            Wait(500)
        end

        if Stripssss.Menu.Command then
            RegisterCommand(Stripssss.Menu.Command, function()
                if isPolice or not Stripssss.RequireJobRemove then
        ...
        if Stripssss.Framework == "esx" and not Stripssss.FrameworkFeatures.UseWarmenu then
            while not ESX do
                Wait(500)
            end
        ...
        elseif Stripssss.Framework == "qb" and not Stripssss.FrameworkFeatures.UseWarmenu then
            while not QBCore do
                Wait(500)
            end
