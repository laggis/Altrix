...
AddEventHandler('esx:playerLoaded', function(source)
  ...
  for i=1, #DataStoresIndex, 1 do
    ...
    local dataStore = GetDataStore(name, xPlayer.characterId)

    if dataStore == nil then

      print("Creating New Datastore " .. name .. " " .. xPlayer.characterId)
      ...
      dataStore = CreateDataStore(name, xPlayer.characterId, {})
      table.insert(DataStores[name], dataStore)
    end
